import type { DashboardResponse, FundCard } from '@fundcat/contracts'
import {
  closestCenter,
  DndContext,
  type DragEndEvent,
...
import { aggregateHoldings, formatCompactPercent, formatCurrency } from '../lib/fundInsights'
...
export function HoldingsPage({
  ...
  const rows = useMemo<HoldingRow[]>(() => {
    return aggregateHoldings(dashboard, funds).map((holding) => {
